    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-6">PT Citra Rasa</div>
            </a>
                ...
                <div class="container-fluid">
                    <div class="container mt-5">
                        ...
                        <form action="{{ route('transactions.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="vehicle_id" class="form-label">Tipe Kendaraan</label>
                                <select class="form-select" id="vehicle_id" name="vehicle_id" required>
                                    <option value="">Pilih Tipe Kendaraan</option>
                                    @foreach($vehicles as $vehicle)
                                        <option value="{{ $vehicle->id }}">{{ $vehicle->type }} - Rp {{ number_format($vehicle->price, 0, ',', '.') }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        @if(session('isEligibleForFreeService'))
